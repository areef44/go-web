...
func Upload(w http.ResponseWriter, r *http.Request) {
	...
	//menentukan besaran ukuran file yang diupload
...
//go:embed resources/capibara.jpeg
...
func TestUploadFile(t *testing.T) {
	...
	writer.WriteField("name", "Muhammad Arif")
	file, _ := writer.CreateFormFile("file", "namafileupload.png")
